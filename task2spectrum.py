...
def cgpa(regd):
    global phy_sco, chem_sco, math_sco
    cgpa_ = 0
    sum = phy_sco + chem_sco + math_sco
    cgpa_ = (sum / 300) * 10
...
def sub_entry(window, regd):
    global flag1, flag2, flag3, phy_sco, chem_sco, math_m
    flag = False
    if (flag1 == True and flag2 == True and flag3 == True):
        ...
        try:
            ...
            cursor = con.cursor()
            cursor.execute(
                f"UPDATE marks SET physics = {phy_sco},chemistry={chem_sco},math = {math_sco} WHERE regd = '{regd}'")
...
def phy():
    global phy_sco, flag1
    phy_sco = simpledialog.askinteger('input', 'please enter physics marks')
    flag1 = True
    # print(phy_sco)


def chem():
    global chem_sco, flag2
    chem_sco = simpledialog.askinteger('input', 'please enter chemistry marks')
    flag2 = True
    # print(chem_sco)


def math():
    global math_sco, flag3
    math_sco = simpledialog.askinteger('input', 'please enter maths marks')
    flag3 = True
    # print(math_sco)
